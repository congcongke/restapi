...
// GetGCHistoryParams contains all the bound params for the get GC history operation
...
func (o *GetGCHistoryParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetGCHistoryParams()
		return nil
	}
...
func (o *GetGCHistoryParams) bindPageSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetGCHistoryParams) validatePageSize(formats strfmt.Registry) error {
...
func (o *GetGCHistoryParams) bindQ(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
