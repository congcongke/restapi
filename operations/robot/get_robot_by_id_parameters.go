...
// GetRobotByIDParams contains all the bound params for the get robot by ID operation
...
func (o *GetRobotByIDParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetRobotByIDParams) validateXRequestID(formats strfmt.Registry) error {
...
func (o *GetRobotByIDParams) bindRobotID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
