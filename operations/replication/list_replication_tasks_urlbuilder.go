...
func (o *ListReplicationTasksURL) Build() (*url.URL, error) {
	...
	var _path = "/replication/executions/{id}/tasks"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on ListReplicationTasksURL")
	}
	...
	var resourceTypeQ string
	if o.ResourceType != nil {
		resourceTypeQ = *o.ResourceType
	}
	if resourceTypeQ != "" {
		qs.Set("resource_type", resourceTypeQ)
	}
...
func (o *ListReplicationTasksURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListReplicationTasksURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListReplicationTasksURL")
	}
