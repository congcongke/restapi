...
func (o *ListRobotV1URL) Build() (*url.URL, error) {
	...
	var _path = "/projects/{project_name_or_id}/robots"

	projectNameOrID := o.ProjectNameOrID
	if projectNameOrID != "" {
		_path = strings.Replace(_path, "{project_name_or_id}", projectNameOrID, -1)
	} else {
		return nil, errors.New("projectNameOrId is required on ListRobotV1URL")
	}
...
func (o *ListRobotV1URL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListRobotV1URL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListRobotV1URL")
	}
