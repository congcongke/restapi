...
func (o *ListExecutionsURL) Build() (*url.URL, error) {
	...
	var _path = "/projects/{project_name}/preheat/policies/{preheat_policy_name}/executions"
...
func (o *ListExecutionsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListExecutionsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListExecutionsURL")
	}
