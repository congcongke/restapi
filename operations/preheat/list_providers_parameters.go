...
func (o *ListProvidersParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListProvidersParams) validateXRequestID(formats strfmt.Registry) error {
