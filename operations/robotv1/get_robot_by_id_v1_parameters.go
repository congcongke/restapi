...
// GetRobotByIDV1Params contains all the bound params for the get robot by ID v1 operation
...
func (o *GetRobotByIDV1Params) bindXIsResourceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetRobotByIDV1Params()
		return nil
	}
...
func (o *GetRobotByIDV1Params) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetRobotByIDV1Params) validateXRequestID(formats strfmt.Registry) error {
...
func (o *GetRobotByIDV1Params) bindProjectNameOrID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetRobotByIDV1Params) bindRobotID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
