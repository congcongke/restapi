...
// CreateRobotV1Params contains all the bound params for the create robot v1 operation
...
func (o *CreateRobotV1Params) bindXIsResourceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateRobotV1Params()
		return nil
	}
...
func (o *CreateRobotV1Params) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRobotV1Params) validateXRequestID(formats strfmt.Registry) error {
...
func (o *CreateRobotV1Params) bindProjectNameOrID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
