...
// TriggerRetentionExecutionParams contains all the bound params for the trigger retention execution operation
...
func (o *TriggerRetentionExecutionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *TriggerRetentionExecutionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
