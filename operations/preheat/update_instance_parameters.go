...
func (o *UpdateInstanceParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateInstanceParams) validateXRequestID(formats strfmt.Registry) error {
...
func (o *UpdateInstanceParams) bindPreheatInstanceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
