...
// GetReplicationExecutionParams contains all the bound params for the get replication execution operation
...
func (o *GetReplicationExecutionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
