...
// CreateRobotParams contains all the bound params for the create robot operation
...
func (o *CreateRobotParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
