...
func (o *ListReplicationExecutionsURL) Build() (*url.URL, error) {
	...
	var _path = "/replication/executions"
...
func (o *ListReplicationExecutionsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListReplicationExecutionsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListReplicationExecutionsURL")
	}
