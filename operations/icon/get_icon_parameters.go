...
// GetIconParams contains all the bound params for the get icon operation
...
func (o *GetIconParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetIconParams) validateXRequestID(formats strfmt.Registry) error {
...
// bindDigest binds and validates parameter Digest from path.
func (o *GetIconParams) bindDigest(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
